...
public final class AttachmentsPlugin implements IMixinConfigPlugin {
    ...
    private static Consumer<URL> fishAddURL() {
        ClassLoader loader = AttachmentsPlugin.class.getClassLoader();
       ...
       /* FabricLoader.getInstance()
        ...
        for (AttachmentManager.AttachmentDeclaration att : AttachmentManager.getAll().values()) {
            ...
            ClassTinkerers.addTransformation(internalName, (targetClass) -> {
                AttachmentsAPI.LOGGER.info(String.format("Transformed %s", internalName));
